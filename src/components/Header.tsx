    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div className="hidden whitespace-nowrap md:flex items-center mr-5 ml-5">
          <a href="tel:+73833838286" className={`podmena_support360 text-lg font-medium transition-colors ${isScrolled ? 'text-primary hover:underline' : 'text-white hover:text-primary'}`}>8 (XXX) XXX-XX-XX</a>
        </div>
